...
def create_student(f_name, l_name, em, gend):
    new_student = Student_Db_Model(
        first_name=f_name, last_name=l_name, email=em, gender=gend
    )
...
def update_student_by_id(
    student_id, f_name=None, l_name=None, student_email=None, student_gender=None
):
    student = (
    ...
    if student != None:
        ...
        if f_name != None:
            ...
            session.commit()
            return {
                "Message": f"First name was succsefully changed for student with student id {student_id}"
            }
        if l_name != None:
            student = (
                session.query(Student_Db_Model)
            ...
            session.commit()
            return {
                "Message": f"Last name was succsefully changed for student with student id {student_id}"
            }
        if student_email != None:
            ...
            session.commit()
            return {
                "Message": f"Email was succsefully changed for student with student id {student_id}"
            }
        if student_gender != None:
            ...
            session.commit()
            return {
                "Message": f"Gender was succsefully changed for student with student id {student_id}"
            }
    else:
